...
1. **Launch Claude Code with Chrome**: Start Claude Code with the `--chrome` flag:
...
2. **Ask Claude to use the browser**: This example navigates to a page, interacts with it, and reports what it finds:
...
Claude can read console output to help diagnose problems:
