...
**Alternative**: Use the official Anthropic app at [https://github.com/apps/claude](https://github.com/apps/claude)
...
3. **Create IAM Role for GitHub Actions** with Bedrock permissions
4. Store `AWS_ROLE_TO_ASSUME` as a repository secret

#### Google Vertex AI

1. **Enable APIs**: IAM Credentials API, STS API, Vertex AI API
2. **Create Workload Identity Federation** resources for GitHub OIDC
3. **Create a Service Account** with `Vertex AI User` role
4. Store `GCP_WORKLOAD_IDENTITY_PROVIDER` and `GCP_SERVICE_ACCOUNT` as secrets

### Step 3: Add Required Secrets

#### For Claude API (Direct):
* `ANTHROPIC_API_KEY`
* `APP_ID` and `APP_PRIVATE_KEY` (if using your own app)
...
* **Custom GitHub App**: For organizations needing branded usernames or custom authentication flows.
...
1. **CLAUDE.md**: Define coding standards, review criteria, and project-specific rules in a `CLAUDE.md` file at the root of your repository. Check out our [Memory documentation](/en/memory) for more details.
